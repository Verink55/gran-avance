...
public class Domiciliario {
    ...
    public Domiciliario(Integer idDomiciliario, @NotEmpty String foto, @NotEmpty String tipodoc,
            @NotEmpty @Size(min = 8, max = 15) Integer noDocumento, @NotEmpty @Size(min = 10, max = 25) String nombre,
            @NotEmpty @Size(min = 10, max = 25) String apellido, @NotEmpty @Size(min = 10, max = 10) Integer telefono,
            @NotEmpty @Size(min = 3, max = 10) String tipoTransporte, Boolean estado, Domicilio domicilio) {
